<div class="max-w-3xl mx-auto">
    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 " role="alert">
        ...
        <p>Su estado actual es: </p>
        <h4 class="uppercase text-2xl">{{$status}}</h4>.
    </div>

    <div class="grid sm:grid-cols-1 md:grid-cols-4 gap-4 ring mt-5 mb-5 rounded-lg p-5">
        <div></div>
        <a href="" wire:click.prevent="$dispatch('cambiando')" class="text-black bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-yellow-200 dark:focus:ring-yellow-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize">
            <i class="fa-brands fa-creative-commons-sa"></i>{{$estNombre}}
        </a>
